...
def buttons():
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 14 <= pyxel.mouse_x <= 64 and pyxel.mouse_y >= 350:
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 70 <= pyxel.mouse_x <= 120 and pyxel.mouse_y >= 350:
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 126 <= pyxel.mouse_x <= 176 and pyxel.mouse_y >= 350:
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 182 <= pyxel.mouse_x <= 232 and pyxel.mouse_y >= 350:
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 238 <= pyxel.mouse_x <= 288 and pyxel.mouse_y >= 350:
    ...
    if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and 294 <= pyxel.mouse_x <= 344 and pyxel.mouse_y >= 350:
